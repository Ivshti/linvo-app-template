...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.10-build.2145+sha.6a9ccac/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.10-build.2145+sha.6a9ccac',    // all of these placeholder strings will be replaced by grunt's
